...
caves[4] = cave:new("The Silver Mirror", 4, {4, 12, 0, 8, 3})
caves[5] = cave:new("The Gallimaufry", 5, {4, 8, 3, 9, 11})
caves[6] = cave:new("The Den of Iniquity", 6, {4, 14, 13, 2, 7})
caves[7] = cave:new("The Findledelve", 7, {3, 3, 6, 19})
caves[8] = cave:new("The Page of the Deniers", 8, {3, 5, 1, 4})
caves[9] = cave:new("The Final Tally", 9, {4, 0, 10, 12, 5})
caves[10] = cave:new("Ess Four", 10, {2, 9, 15})
caves[11] = cave:new("The Trillion", 11, {3, 14, 16, 5})
caves[12] = cave:new("The Scrofula", 12, {2, 4, 9})
caves[13] = cave:new("Ephemeron", 13, {4, 6, 16, 8, 14})
